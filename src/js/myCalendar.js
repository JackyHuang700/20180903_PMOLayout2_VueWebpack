(function () {
  ...
  var popTemplate = ['<div class="popover" style="max-width:600px;" >', '<div class="arrow"></div>', '<div class="popover-header">', '<button id="closepopover" type="button" class="close" aria-hidden="true">&times;</button>', '<h3 class="popover-title"></h3>', '</div>', '<div class="popover-content"></div>', '</div>'].join('');
  var popoverElement;
      ...
      select: function select(start, end, jsEvent) {
        ...
        $(jsEvent.target).popover({
          ...
          content: function content() {
            return '<div class="popoverContent">' + '  <input type="text" class="form-control" id="popoverContentInput"/>' + '  <button type="button" class="btn btn-primary" id="savePopover">儲存</button>' + '</div>';
          },
